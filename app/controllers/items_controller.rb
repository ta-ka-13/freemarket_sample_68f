class ItemsController < ApplicationController
  ...
  private
  def item_params
    params.require(:item).permit(:name, :price, :description, category_ids: [], :ancestry, :condition, :shopping_charges, :shopping_area, :shopping_date, images_attributes: [:image, :_destroy, :id])
  end
